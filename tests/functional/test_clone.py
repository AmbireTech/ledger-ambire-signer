...
@pytest.mark.needs_setup("lib_mode")
def test_clone_thundercore_get_address(
    scenario_navigator: NavigateWithScenario, test_name: str
) -> None:
    ...
    ref_pk, _ = calculate_public_key_and_chaincode(
        curve=CurveChoice.Secp256k1, path=BIP32_PATH
    )
