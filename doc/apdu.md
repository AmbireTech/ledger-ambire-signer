...
The application supports signing legacy or [EIP 2718](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-2718.md) transactions for Type 2 ([EIP 1559](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1559.md)) and Type 4 ([EIP 7702](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7702.md)).
...
This command computes the signature for an element of a EIP 7702 Authorization list ([EIP 7702](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7702.md)) on the given account, for the given delegate, chain ID and nonce.
