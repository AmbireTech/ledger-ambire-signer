...
* *P1 = 01 (TLV)*: TLV dynamic descriptor payload as defined in link:tlv_structs.md#dynamic_token_descriptor[DYNAMIC_TOKEN_DESCRIPTOR], signed via the Ledger PKI (key usage `COIN_META`). Supports multi-APDU chunking via P2.
...
|===================================================================================
   | *CLA*    | *INS*  | *P1*                   | *P2*                    | *LC*
.2+| E0    .2+| 0A     | 00 : legacy format     | 00                   .2+| variable
                       | 01 : TLV format        | 01 : first chunk +
                                                  00 : following chunk
|===================================================================================
...
| *Description*                                                                 | *Length*
| Payload length                                                                | 2
| link:tlv_structs.md#dynamic_token_descriptor[DYNAMIC_TOKEN_DESCRIPTOR struct] | variable
|=========================================================================================
...
See link:tlv_structs.md#field[FIELD struct] for the full field layout and parameter types.
